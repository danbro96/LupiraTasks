...
4. **First release only — complete the gating declarations** (see `docs/mobile/play-store-submission.md`):
   privacy policy URL (host `docs/mobile/PRIVACY.md`), Data safety, App access (+ test account), content
