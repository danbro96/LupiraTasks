...
export const getListListItemsUrl = (listId: string,
  ...
  return stringifiedParams.length > 0 ? `/api/api/lists/${listId}/items?${stringifiedParams}` : `/api/api/lists/${listId}/items`
}
...
export const getCreateListItemUrl = (listId: string,) => {
  ...
  return `/api/api/lists/${listId}/items`
}
...
export const getUpdateListItemUrl = (listId: string,
  ...
  return `/api/api/lists/${listId}/items/${itemId}`
}
...
export const getDeleteListItemUrl = (listId: string,
  ...
  return stringifiedParams.length > 0 ? `/api/api/lists/${listId}/items/${itemId}?${stringifiedParams}` : `/api/api/lists/${listId}/items/${itemId}`
}
...
export const getCompleteItemUrl = (listId: string,
  ...
  return `/api/api/lists/${listId}/items/${itemId}/complete`
}
...
export const getMoveItemUrl = (listId: string,
  ...
  return `/api/api/lists/${listId}/items/${itemId}/move`
}
...
export const getReopenItemUrl = (listId: string,
  ...
  return `/api/api/lists/${listId}/items/${itemId}/reopen`
}
