 ...
 */
export const redeemShare = async (redeemShareRequest: RedeemShareRequest, options?: Parameters<typeof customFetch>[1]): Promise<RedeemShareResponse> => {
...
export const getRedeemShareMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof redeemShare>>, TError,RedeemShareMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
...
export const createShare = async (listId: string,
    createShareRequest: CreateShareRequest, options?: Parameters<typeof customFetch>[1]): Promise<ShareDto> => {
...
export const getCreateShareMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createShare>>, TError,CreateShareMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
 ...
 */
export const listShares = async (listId: string, options?: Parameters<typeof customFetch>[1]): Promise<ShareDto[]> => {
...
export const deleteShare = async (listId: string,
    shareId: string, options?: Parameters<typeof customFetch>[1]): Promise<void> => {
...
export const getDeleteShareMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteShare>>, TError,DeleteShareMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
