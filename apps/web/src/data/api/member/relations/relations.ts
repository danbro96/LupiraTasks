...
export const getCreateRelationMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createRelation>>, TError,CreateRelationMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
...
export const listRelations = async (listId: string,
    itemId: string, options?: Parameters<typeof customFetch>[1]): Promise<RelationDto[]> => {
...
export const deleteRelation = async (listId: string,
    itemId: string,
    params: DeleteRelationParams, options?: Parameters<typeof customFetch>[1]): Promise<void> => {
...
export const getDeleteRelationMutationKey = () => ['deleteRelation'] as const;

export const getDeleteRelationMutationOptions = <TError = ProblemDetails,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteRelation>>, TError,DeleteRelationMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteRelation>>, TError,DeleteRelationMutationVariables, TContext> => {

const mutationKey = getDeleteRelationMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteRelation>>, DeleteRelationMutationVariables> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteRelationMutationVariables = {listId: string;itemId: string;params: DeleteRelationParams}
