...
import type { SharedItemResponse, SharedListResponse } from '../api/shareTypes';
import type { SharedListController } from '../hooks/useSharedList';
...
interface Props {
  ...
  canEdit: boolean;
  actions: SharedListController['actions'];
  onClose: () => void;
