// Lightweight due-date helpers. Ported verbatim from the mobile app (src/domain/dueDate.ts)
// so quick-picks and labels match exactly.
...
/** ISO for end-of-day on a specific calendar date (from the date input). */
